...
# create export dir
export_dir <- "../../HYDI_SOURCE_nd_qa3_csv"
dir.create(export_dir)
library(readr)
for (tbl in names(hydi)){
  readr::write_csv(hydi[[tbl]], file = paste(export_dir,"/",tbl,".csv", sep=""))
}
# manually fix special characters encoding problems and add missing addresses.
## -------
...
ch <- odbcConnectAccess2007("../HYDI-v1.accdb")
...
file.copy(c("HYDI_SOURCE_nd_qa3.Rdata","HYDI2mdb.r","../HYDI-v1_BETA.accdb"),rep("C:/Users/weyname/Dropbox/EU-HYDI/EU-HYDI_Rcode",3),overwrite=TRUE)
