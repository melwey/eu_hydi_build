...
# P_M : pretreatment by hydrogen peroxide (H2O2) to destroy organic matter and by hydrochloric acid (HCl) to remove alkaline carbonates. After dispersion by sodium pyrophosphate (Na4P2O7) the contents of silt (2 � 63 �m) and clay (< 2 �m) fractions were measured by pipette sampling and contents of four sand fractions (63 � 125 �m, 125 � 200 �m, 200 � 630 �m, 630 � 2000 �m) were determined by wet sieving 
bgr_psd <- data.frame(CODE_M=500,METHOD='pretreatment by H2O2 and HCl, dispersion by a4P2O7, pipette method for silt (2 � 63 �m) and clay (< 2 �m) fractions and wet sieving for four sand fractions (63 � 125 �m, 125 � 200 �m, 200 � 630 �m, 630 � 2000 �m)',METH_REF='ND',METH_PAR='COND_M',stringsAsFactors=FALSE)
...
METH_REF=c("ND","Schindler, U. 1980. Ein Schnellverfahren zur Messung der Wasserleitf�higkeit im teilges�ttigten Boden an Stechzylinderproben.","Schindler, U. 1980. Ein Schnellverfahren zur Messung der Wasserleitf�higkeit im teilges�ttigten Boden an Stechzylinderproben."),
